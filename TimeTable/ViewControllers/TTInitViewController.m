...
@interface TTInitViewController ()
...
*/
- (void) _initSlideViewController
{
    TTAppDelegate *appDelegate = [[UIApplication sharedApplication] delegate];
    
    if (self.topViewController == nil)
    {
        self.topViewController = [appDelegate findViewControllerFromStroyboardIdentifier:@"topNavigationVC"];
    }
}
